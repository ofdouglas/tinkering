...
module system_peripherals #(
    parameter int ADDR_MSB = PERIPH_ADDR_MSB + 1
) (
...
localparam logic [ADDR_MSB:PERIPH_ADDR_MSB+1] PERIPH_GPIO = '0;
localparam logic [ADDR_MSB:PERIPH_ADDR_MSB+1] PERIPH_UART = 'd1;
